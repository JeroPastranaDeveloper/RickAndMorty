...
class DateFilterAdapter (private var episodes: List<Episode>, private val onEpisodeClick: OnEpisodeClick) :
    RecyclerView.Adapter<DateFilterAdapter.EpisodeViewHolder>() {
